...
- Watch a page: re-check it later and get told whether it changed and exactly which fields moved. If the page hasn't changed, the re-check is almost free (no re-download, no AI call): it asks the server "has this changed since I last looked?" first.
